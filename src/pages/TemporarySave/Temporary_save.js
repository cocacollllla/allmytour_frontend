...
import Language from '../Applying/Aside/Language.js';
import Certificate from '../Applying/Aside/Certificate';
import IdCard from '../Applying/Aside/IdCard';
import Profile from '../Applying/Aside/Profile';
import axios from 'axios';
import { useHistory } from 'react-router-dom';
import { API } from '../../config';
import Submission_Modal from '../Applying/Aside/Submission_Modal';
import { useParams } from 'react-router-dom';

const Temporary_save = () => {
  ...
  useEffect(() => {
    ...
    bodyFormData.get('id_image', idFile);
          ...
          <form method="post" enctype="multipart/form-data">
            <div className="applying_page_whole_wrap">
              ...
              <main className="contents" key="index">
                ...
                ${
                  nickValue.length >= 1 || test.nickname !== null
                ...
                ${
                  profileValue.length >= 1 || test.description !== null
                    ? 'career_used_input'
                ...
                <div className="user_sns_wrap">
                  <div className="category_hp_or_sns">
                    ...
                    <div className="sns_desc">
                      가이드로서의 활동을 알 수 있는 홈페이지, sns 등 주소가
                      있다면 입력해주세요.
                    </div>
                  </div>
                  ...
                  ${
                    igValue.length >= 1 || test.instagram !== null
                      ? 'instagram_input_used'
                      : ''
                  }`}
                      ...
                      <input
                        ...
                        defaultValue={`${
                          igValue.length < 1 ? test.instagram : igValue
                        }`}
                ...
                ${
                  fbValue.length >= 1 || test.facebook !== null
                    ? 'facebook_input_used'
                    : ''
                }`}
                      ...
                      <input
                        ...
                        defaultValue={`${
                          fbValue.length < 1 ? test.facebook : fbValue
                        }`}
                ...
                ${
                  ytValue.length >= 1 || test.instagram !== null
                    ? 'youtube_input_used'
                    : ''
                }`}
                      ...
                      <input
                        ...
                        defaultValue={`${
                          ytValue.length < 1 ? test.youtube : ytValue
                        }`}
